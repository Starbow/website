...
describe("ThinkyDocumentModel", function(){
  ...
  describe("Instances (i.e.: new ThinkyDocumentModel)", function(){
    ...
    it("Is instantiable", function(){
      ...
      assert.typeOf(thinkyDocumentModel, "object");
    ...
    describe("getThinky()", function(){
      it("Should return same Object as the static 'getThinky'", function(){
        var thinkyDocumentModel = new ThinkyDocumentModel;
        var staticThinky = ThinkyDocumentModel.getThinky();
        assert.deepEqual(thinkyDocumentModel.getThinky(), staticThinky);
      });
    });
